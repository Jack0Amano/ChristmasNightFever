	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV22 = dot( WorldNormal, ase_viewDirWS );
				float fresnelNode22 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV22, 5.0 ) );
				float4 lerpResult23 = lerp( float4( 0,0,0,0 ) , _EdgeEmissionColor , ( fresnelNode22 * _EdgePower ));
				

				float3 BaseColor = _Color.rgb;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = lerpResult23.rgb;
				float3 Specular = 0.5;
				float Metallic = _Metalic;
				float Smoothness = _Metalic;
				float Occlusion = 1;
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNdotV22 = dot( ase_worldNormal, ase_viewDirWS );
				float fresnelNode22 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV22, 5.0 ) );
				float4 lerpResult23 = lerp( float4( 0,0,0,0 ) , _EdgeEmissionColor , ( fresnelNode22 * _EdgePower ));
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-381.8566,383.6226;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;24;-560,128;Inherit;False;Property;_EdgeEmissionColor;EdgeEmissionColor;1;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;19;-384,-224;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FresnelNode;22;-720,336;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-544.3147,569.5579;Inherit;False;Property;_EdgePower;EdgePower;2;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;23;-256,96;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;27;-256,0;Inherit;False;Property;_Metalic;Metalic;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=BB90C4E883772FDF04B63B0B31697A518DD4DDD1