...
Shader "Icicle"
{
	Properties
	{
		...
		_Color0("Color 0", Color) = (0.8457191,0.990566,0.9899288,0.6470588)
		_Metalic("Metalic", Range( 0 , 1)) = 0.6684783
		_EdgeEmissionColor("EdgeEmissionColor", Color) = (0,0,0,0)
		_Smoothness("Smoothness", Range( 0 , 1)) = 0.8478261
	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float fresnelNdotV27 = dot( WorldNormal, ase_viewDirWS );
				float fresnelNode27 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV27, 5.0 ) );
				float4 lerpResult29 = lerp( float4( 0,0,0,0 ) , _EdgeEmissionColor , ( fresnelNode27 * _EdgePower ));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float fresnelNdotV27 = dot( ase_worldNormal, ase_viewDirWS );
				float fresnelNode27 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV27, 5.0 ) );
				float4 lerpResult29 = lerp( float4( 0,0,0,0 ) , _EdgeEmissionColor , ( fresnelNode27 * _EdgePower ));
...
/*ASEBEGIN
Version=19701
Node;AmplifyShaderEditor.ColorNode;10;-368,-80;Inherit;False;Property;_Color0;Color 0;0;0;Create;True;0;0;0;False;0;False;0.8457191,0.990566,0.9899288,0.6470588;1,1,1,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;11;-400,144;Inherit;False;Property;_Metalic;Metalic;1;0;Create;True;0;0;0;False;0;False;0.6684783;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;12;-400,224;Inherit;False;Property;_Smoothness;Smoothness;3;0;Create;True;0;0;0;False;0;False;0.8478261;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;13;-336,323.25;Inherit;False;Property;_Emission;Emission;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;-496,800;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;26;-672,544;Inherit;False;Property;_EdgeEmissionColor;EdgeEmissionColor;2;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.FresnelNode;27;-832,752;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;28;-656,976;Inherit;False;Property;_EdgePower;EdgePower;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;29;-368,512;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=294005F0B9A55B261808017E7E349213E848E31B